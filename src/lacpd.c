...
lacpd_init(const char *db_path, struct unixctl_server *appctl)
{
    ...
    unixctl_command_register("lacpd/getlacpinterfaces", "", 0, 1, lacpd_unixctl_getlacpinterfaces, NULL);
    unixctl_command_register("lacpd/getlacpcounters", "", 0, 1, lacpd_unixctl_getlacpcounters, NULL);
    unixctl_command_register("lacpd/getlacpstate", "", 0, 1, lacpd_unixctl_getlacpstate, NULL);

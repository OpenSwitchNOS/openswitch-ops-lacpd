...
### Test Result Criteria
#### Test Pass Criteria
* Interfaces 1 and 2 should be In Sync and Collecting/Distributing for interfaces 1 and 2 in both switches
...
* Create LAG 350 in switch 2 in active mode with interfaces 5 and 3
	* Apply aggregation key 150 to interfaces 5 and 3

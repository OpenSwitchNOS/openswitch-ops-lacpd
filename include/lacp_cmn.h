...
/* [(<local_system_priority>, <local_system_mac_addr>, <local_port_key>, <local_port_priority>, <local_port_number>), */
/* (<remote_system_priority>, <remote_system_mac_addr>, <remote_port_key>, <remote_port_priority>, <remote_port_number>)] */

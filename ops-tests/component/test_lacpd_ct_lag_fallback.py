...
#
##############################################################################
def disabld_test_nf_toggle_admin_flag(topology, step, main_setup):
    """Toggle 'admin' flag.
...
def test_nf_toggle_lacp_flag_active(topology, step, main_setup):
    ...
    set_port_parameter(sw2, test_lag, ['other_config:lacp-time=slow'])
    set_port_parameter(sw2, test_lag, ['other_config:lacp-time=fast'])
    print('Verify all interface SM from both switches are working')
    sw_wait_until_all_sm_ready([sw1, sw2], sw_1g_intf, active_ready)
...
def test_nf_toggle_lacp_flag_passive(topology, step, main_setup):
    ...
    set_port_parameter(sw1, test_lag, active_lag)
    set_port_parameter(sw1, test_lag, ['other_config:lacp-time=slow'])
    set_port_parameter(sw1, test_lag, ['other_config:lacp-time=fast'])
    print('Verify all interface SM from both switches are working')
    sw_wait_until_all_sm_ready([sw1, sw2], sw_1g_intf, active_ready)


def disabled_test_nf_false_flag_toggle_admin_flag(topology, step, main_setup):
...
#
##############################################################################
def disabled_test_fb_toggle_admin_flag(topology, step, main_setup):
    """Toggle 'admin' flag.

...
def test_lacp_bond_status(topology):
    """
    ...
    print("Creating dynamic lag with 4 interfaces")
    ...
    print("Verify that turned off interfaces bond_status is down")
    ...
    print("Verify interface is not part of LAG and bond_status is empty.")
    ...
    print("Verify LAG bond status is UP")
    verify_port_bond_status(sw1, lag_name, "up", "Expected the LAG "
                            "to have bond status UP")
    ...
    print("Remove partner interfaces 2")
    ...
    print("Add partner interface back to LAG")
    ...
    print('Disabling Fallback on both switches')
    ...
    print("Verify LAG bond status is DOWN when LAG has no interfaces")
    verify_port_bond_status(sw1, lag_name, "down", "Expected the LAG "
                            "to have bond status DOWN")

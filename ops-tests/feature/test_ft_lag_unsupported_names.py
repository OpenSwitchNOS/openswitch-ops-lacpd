...
#                       configured using valid name and cannot be configured
#                            name longer than permitted or containing invalid
#                            characters.
#
#                    FAILED -> This test fails if the LAG (statc or dynamic)

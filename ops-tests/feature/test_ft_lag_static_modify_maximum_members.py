...
###############################################################################
# Name         test_ft_lag__static_modify_maximum_member.py
#
...
from lacp_lib import verify_connectivity_between_hosts
from lacp_lib import validate_interface_not_in_lag
...
def test_static_modify_maximum_members(topology):
    ...
    print("### Remove one interface from each LAG ###")
    remove_interface_from_lag(sw1, p12, lag_id)
    remove_interface_from_lag(sw2, p22, lag_id)

    print("### Validate if the interface was removed of LAG ###")
    validate_interface_not_in_lag(sw1, p12, lag_id)
    validate_interface_not_in_lag(sw2, p22, lag_id)

...
def clean_up_devices(sw1, sw2, h1, h2):
    ...
    finalresult.append(createlag(sw1, '1', False, [], 'off'))
    finalresult.append(createlag(sw2, '1', False, [], 'off'))
...
def test_ft_static_lag_delete_non_existing_lags(topology, step):
    ...
    step("Create LAGs")
    print("############################################")
    assert(createlag(sw1, '1', True, [sw1p2, sw1p3], 'off'))
    assert(createlag(sw2, '1', True, [sw2p2, sw2p3], 'off'))
    ...
    print("\n############################################")
    step("Delete non-existent LAGs")
    print("############################################")
    print('With ID XX')
    with raises(UnknownCommandException):
        assert(deletelagnegative(sw1, 'XX', '1', 'off', [sw1p2, sw1p3],
                                 'l3-src-dst', False, False))
    print('With ID 0')
    with raises(UnknownCommandException):
        assert(deletelagnegative(sw1, '0', '1', 'off', [sw1p2, sw1p3],
                                 'l3-src-dst', False, False))
    print('With ID -1')
    with raises(UnknownCommandException):
        assert(deletelagnegative(sw1, '-1', '1', 'off', [sw1p2, sw1p3],
                                 'l3-src-dst', False, False))
    print('With ID 2000')
    with raises(UnknownVtyshException):
        assert(deletelagnegative(sw1, '2000', '1', 'off', [sw1p2, sw1p3],
                                 'l3-src-dst', False, False))
    print('With ID 2001')
    with raises(UnknownCommandException):
        assert(deletelagnegative(sw1, '2001', '1', 'off', [sw1p2, sw1p3],
                                 'l3-src-dst', False, False))
    print('With ID @%&$#()')
    with raises(UnknownCommandException):
        assert(deletelagnegative(sw1, '@%&$#()', '1', 'off', [sw1p2, sw1p3],
                                 'l3-src-dst', False, False))
    print('With ID 60000')
    with raises(UnknownCommandException):
        assert(deletelagnegative(sw1, '60000', '1', 'off', [sw1p2, sw1p3],
                                 'l3-src-dst', False, False))
    print('With ID 600')
    with raises(UnknownVtyshException):
        assert(deletelagnegative(sw1, '600', '1', 'off', [sw1p2, sw1p3],
                                 'l3-src-dst', False, False))
    print('With ID 2')
    with raises(UnknownVtyshException):
        assert(deletelagnegative(sw1, '2', '1', 'off', [sw1p2, sw1p3],
                                 'l3-src-dst', False, False))

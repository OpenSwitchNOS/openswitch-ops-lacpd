...
from lacp_lib import lag_no_passive
from lacp_lib import lag_no_active
...
def test_dynamic_to_static(topology):
    ...
    print("### Change the LAGs on both switches to static ###")

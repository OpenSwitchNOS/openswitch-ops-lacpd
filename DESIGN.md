...
Additionally, ops-lacpd configures the bonding driver to create bond interfaces using the Linux virtual interfaces correspondent to the physical interfaces that are members of the LAG.
